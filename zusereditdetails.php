...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$sql="UPDATE user2 SET username ='". $userName."', email ='". $email."', password ='". $password."', mobileno ='". $mobileno."', email2 ='". $email2."', mobileno2 ='". $mobileno2."', masjidname ='". $masjidname."', address ='". $address."', city ='". $city."', zipcode ='". $zipcode."', state ='". $state."', addresslink ='". $addresslink."' WHERE id ='".$_SESSION['id']."'";
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(images/bg-04.jpg);">
					...
					Edit <?php echo $_SESSION['email']; ?> Details
					</span>
				</div>
