...
<div class="search-input">
    <input type="text" placeholder="Search.." id="searchTerm" onKeyUp="handleKeyUp()" onFocus="showDropdown()">
...
<script>
    function clearInputAndOpenDropdown() {
        ...
        var inputFieldzip = document.getElementById("searchTerm2");        
        var inputFieldmasjidname = document.getElementById("searchTerm3");

        // Clear the input field
        inputField.value = "";
        inputFieldzip.value = "";        
        inputFieldmasjidname.value = "";
...
<script>
    ...
    function clearzipmasjidinput() {
        var inputField2 = document.getElementById("searchTerm2");
        var dropdownContent2 = document.getElementById("myDropdown2");
        var inputField3 = document.getElementById("searchTerm3");
    ...
    function selectCity(city) {
        ...
        searchcity(); // Perform the search when a city is selected
    }*/ 
...
<div class="search-input">
    <input type="text" placeholder="Search.." id="searchTerm2" onKeyUp="handleKeyUp2()" onFocus="showDropdown2()">
...
<script>
    function selectCity(city) {
        ...
        showDropdown2(); // Close the zip code dropdown when a city is selected
        getZipcodes(city); // Fetch zip codes based on the selected city
        searchcity();
        
        // Closing dropdown list of city zip and masjid
        document.getElementById("myDropdown").classList.remove("show");
    ...
    function getZipcodes(city) {
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("myDropdown2").innerHTML = this.responseText;
            }
        };
        xhttp.open("GET", "dropdownfilteredvalues.php?city=" + city, true);
        xhttp.send();
    }
</script>
...
<script>
    ...
    function selectZipcode(zipcode) {
        ...
        document.getElementById("myDropdown2").classList.remove("show");
        searchzipcode(); // Perform the search when a zipcode is selected
    }*/
...
<script>
    function selectZipcode(zipcode) {
        ...
        searchTerm2.value = zipcode;
        showDropdown2(); // Close the masjid code dropdown when a zipcode is selected
        getMasjidnames(zipcode); // Fetch masjid codes based on the selected zipcode
        searchzipcode();
        
        // Closing dropdown list of zipcode masjid and masjid
        document.getElementById("myDropdown").classList.remove("show");
        document.getElementById("myDropdown2").classList.remove("show");
        document.getElementById("myDropdown3").classList.remove("show");
    }

    function getMasjidnames(zipcode) {
        var xhttp = new XMLHttpRequest();
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("myDropdown3").innerHTML = this.responseText;
            }
        };
        xhttp.open("GET", "dropdownfilteredvalues.php?zipcode=" + zipcode, true);
        xhttp.send();
    }
</script>
...
<script>
    ...
    function selectMasjidname(masjidname) {
        document.getElementById("searchTerm3").value = masjidname;
        document.getElementById("myDropdown3").classList.remove("show");
        searchmasjidname(); // Perform the search when a masjidname is selected
    }
